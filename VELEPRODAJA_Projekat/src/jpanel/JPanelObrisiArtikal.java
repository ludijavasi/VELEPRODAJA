...
public class JPanelObrisiArtikal extends JPanel {
	...
	public JPanelObrisiArtikal() {
		...
		panelObrisiArtikal.setBorder(new TitledBorder(null, "Obrisi artikal", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		textFieldNazivArtikla.setFont(new Font("Tahoma", Font.PLAIN, 14));
		textFieldNazivArtikla.setBounds(47, 146, 172, 20);
		panelObrisiArtikal.add(textFieldNazivArtikla);
