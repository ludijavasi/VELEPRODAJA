...
public class JFrameArtikal extends JFrame {
	...
	public JFrameArtikal() {
		...
		panelArtikal.setBorder(new TitledBorder(null, "Podaci o artiklu", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		JLabel lblRobnaGrupaArtikla = new JLabel("Robna grupa artikla :");
		lblRobnaGrupaArtikla.setBounds(27, 80, 128, 14);
		panelArtikal.add(lblRobnaGrupaArtikla);
		
		JLabel lblDatumUpotrebe = new JLabel("Datum upotrebe :");
		lblDatumUpotrebe.setBounds(27, 105, 128, 14);
		panelArtikal.add(lblDatumUpotrebe);
		...
		comboBoxJedinicaMere.setModel(new DefaultComboBoxModel(new String[] {"---------", "Kilogram", "Gram", "Litar", "Komad"}));
		comboBoxJedinicaMere.setBounds(200, 52, 91, 20);
		panelArtikal.add(comboBoxJedinicaMere);
		
		JComboBox comboBoxRobnaGrupa = new JComboBox();
		comboBoxRobnaGrupa.setBounds(200, 77, 91, 20);
		panelArtikal.add(comboBoxRobnaGrupa);
		
		JDateChooser dateChooserDatumUpotrebeArtikla = new JDateChooser();
		dateChooserDatumUpotrebeArtikla.setBounds(200, 105, 91, 20);
		panelArtikal.add(dateChooserDatumUpotrebeArtikla);
		...
		panelEkonomskiPodaciOArtiklu.setBorder(new TitledBorder(null, "Ekonomski podaci o artiklu", TitledBorder.LEADING, TitledBorder.TOP, null, null));
